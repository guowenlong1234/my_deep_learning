...
## 结果展示
| 模型名称     | 数据增强 | 加载预训练模型 | 训练输出层 | 输出层epoch | Resize  | time    | val_acc |   | resnet50 | 数据增强 | 预训练模型 | 训练输出层 | 输出层epoch | Resize  | time   | val_acc |   |   |   |
|----------|------|---------|-------|----------|---------|---------|---------|---|----------|------|-------|-------|----------|---------|--------|---------|---|---|---|
| resnet18 | 是    | 是       | 是     | 10       | 96*96   | 5m35s   | 39.36%  |   |          | 否    | 是     | 是     | 10       | 256*256 | 9m 16s | 93.52%  |   |   |   |
|          |      |         |       | 10       | 256*256 | 13m 1s  | 87.16％  |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         |       | 30       | 96*96   | 16m 27s | 41.19％  |   |          |      |       | 训练所有层 | 所有层epoch | Resize  | time   | val_acc |   |   |   |
|          |      |         |       | 30       | 256*256 | 43m 13s | 90.95%  |   |          |      |       |       |          | 256*256 | 14m 2s | 95.35   |   |   |   |
...
| resnet50 |      |         | 训练输出层 | 输出层epoch | Resize  | time    | val_acc |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         | 是     | 10       | 96*96   | 6m 2s   | 43.15%  |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         |       | 10       | 256*256 | 18m 20s | 91.56%  |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         |       | 30       | 96*96   | 18m 57s | 50.85%  |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         |       | 30       | 256*256 | 55m 38s | 90.95%  |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         | 训练所有层 | 所有层epoch | Resize  | time    | val_acc |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         | 是     | 10       | 96*96   | 6m 47s  | 81.78%  |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         |       | 10       | 256*256 | 20m 32s | 94.74%  |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         |       | 30       | 96*96   | 20m 1s  | 84.10%  |   |          |      |       |       |          |         |        |         |   |   |   |
|          |      |         |       | 30       | 256*256 | 62m 9s  | 95.47%  |   |          |      |       |       |          |         |        |         |   |   |   |
